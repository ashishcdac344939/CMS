 ...
 *   https://datatables.net/download/#bs5-5.3.0/dt-1.13.6/b-2.4.2/date-1.5.1/r-2.5.0/sl-1.7.0
 *
 * Included libraries:
 *   Bootstrap 5 5.3.0, DataTables 1.13.6, Buttons 2.4.2, DateTime 1.5.1, Responsive 2.5.0, Select 1.7.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5-5.3.0/dt-1.13.6/b-2.4.2/date-1.5.1/r-2.5.0/sl-1.7.0",
